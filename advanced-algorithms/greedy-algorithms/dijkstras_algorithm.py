...
class Tests(unittest.TestCase):
    ...
    def test_1(self):
        ...
        self.assertDictEqual(dijkstra(graph, 'A'), {'A': 0, 'D': 2, 'B': 3, 'E': 3, 'C': 4})
    ...
    def test_2(self):
        ...
        self.assertDictEqual(dijkstra(graph, 'A'), {'A': 0, 'C': 10, 'B': 5})
    ...
    def test_3(self):
        ...
        self.assertDictEqual(dijkstra(graph, 'A'), {'A': 0, 'C': 3, 'B': 5, 'E': 4, 'D': 2, 'F': 6})
